...
export const THEMES: ThemeConfig[] = [
  ...
  },
  {
    ...
    name: 'Desert',
    preview: '#d4a55a',
    // Realistic arid desert — warm sandy tones, clear harsh sun
    background: 0xc2a87a,
    fogColor: 0xd4c4a0,
    fogNear: 20,
    fogFar: 110,
  ...
  },
  {
    ...
    name: 'Snow',
    preview: '#dce6f0',
    // Realistic overcast winter — muted blue-gray sky, white ground
    background: 0xc8d6e0,
    fogColor: 0xbeccd8,
    fogNear: 12,
    fogFar: 75,
